...
#       # report % fulfillment by commodity
        ...
        # OKAY 2/11/2020
        # THIS NEEDS TO BE UPDATED SO PROC OUTPUTS TEH SAME INFO AS RMPS AND DEST.
        # GENERAL SPEAKING THERE IS A TOTAL, OPTIMAL, and FRAC record for each commodity coming out of a facility.
        # PROC NEEDS TOTAL AND FRAC. I REPLACED FRAC WITH OPTIMAL, SO WE REALLY JUST NEED TOTAL. I THINK SOME CAREFUL
        # SQL CUT AND PASTE IS ALL THATS NEEDED HERE. 1-2 hours of work
