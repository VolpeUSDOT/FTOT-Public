...
# simulation weeks/days in one year
WeekInYear = 52
DayInYear = 52*7
...
if __name__ == '__main__':
    ...
    try:
        ...
        # optimization
            ...
            #=================================================Modification================================================================
            # Purpose of following part: (a)iterate optimization per week/year; (b)divide yearly and weekly simulation, based on earthquake occurrence;
                ...
                for t in range(plan_horizon):
                       ...
                       for j in range(WeekInYear):
                           ...
                           if j <= temp_repair_week:
                               ...
                               if UDR  > 0:
                                   ...
                                   R3[i] = R3[i] + (float(UD*reward_rate)/float(production))*7
                                   w3[t] = w3[t] + (float(UD*reward_rate)/float(production))
                  ...
                  # for non earthquake occurrence scenario: yearly basis interval   
                       ...
                       if UDR  > 0:
                           ...
                           R3[i] = R3[i] + (float(UD*reward_rate)/float(production))*DayInYear
                           w3[t] = w3[t] + (float(UD*reward_rate)/float(production))
